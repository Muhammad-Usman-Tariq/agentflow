...
export async function getAgentRun(runId: number): Promise<any> {
...
export async function getRunsForChat(chatId: string): Promise<any[]> {
  const result = await query(
