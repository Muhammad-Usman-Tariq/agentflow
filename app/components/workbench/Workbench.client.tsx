...
export const Workbench = memo(
  ({
    ...
    const currentChatId = useStore(chatId); // ← ADD
    const mixedId = !!currentChatId; // ← ADD
    const chatState = useStore(chatStore);
    const chatStartedFromStore = chatState.started; // ← ADD
    ...
    return (
       (chatStarted || showWorkbench || chatStartedFromStore || !!mixedId) && (
        <motion.div
          initial="closed"
